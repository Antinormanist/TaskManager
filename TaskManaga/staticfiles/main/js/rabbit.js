...
window.addEventListener('click', (event) => {
    ...
    else if (event.target.closest('.notification-btn') && notificationsFrame.classList.contains('none')) {
        notificationsFrame.classList.remove('none')
    }
    else if (event.target.closest('.notifications-close-btn')) {
        notificationsFrame.classList.add('none')
    }
    else if (event.target.closest('.commentaries-btn') && commentFrame.classList.contains('none')) {
